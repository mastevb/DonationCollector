...
public class RpcHelper {
    ...
    //get NGO name from Cognito
    public static String getNGOID(HttpServletRequest request) {
    	// Get token in header
    	String NGOID = "";
    	String tokenStr = CognitoClient.getTokenFromRequest(request);
    	// Decode token
    	NGOID = CognitoClient.getContentFromToken(tokenStr, "given_name");
        return NGOID;
    }
	...
	public static Schedule parsePostSchedule(HttpServletRequest request) throws JSONException, IOException {
        ...
        builder.setScheduleTime(input.getString("ScheduleDate"));
        builder.setStatus(0);
